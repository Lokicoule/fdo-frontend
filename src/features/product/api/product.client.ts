...
export type RemoveProductMutation = {
  __typename?: "Mutation";
  removeProduct: { __typename?: "ProductDto"; id: string };
};
...
export const useCreateProductMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: CreateProductMutationVariables) =>
      requestGraphQL<CreateProductMutation, CreateProductMutationVariables>(
...
export const useGetProductQuery = <TData = GetProductQuery, TError = unknown>(
  ...
  useQuery<GetProductQuery, TError, TData>(
    ...
    requestGraphQL<GetProductQuery, GetProductQueryVariables>(
      GetProductDocument,
      variables
    ),
    options
...
export const useGetProductsQuery = <TData = GetProductsQuery, TError = unknown>(
  ...
  useQuery<GetProductsQuery, TError, TData>(
    ...
    requestGraphQL<GetProductsQuery, GetProductsQueryVariables>(
      GetProductsDocument,
      variables
    ),
    options
...
export const useRemoveProductMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: RemoveProductMutationVariables) =>
      requestGraphQL<RemoveProductMutation, RemoveProductMutationVariables>(
...
export const useRemoveProductsMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ["RemoveProducts"],
    (variables?: RemoveProductsMutationVariables) =>
      requestGraphQL<RemoveProductsMutation, RemoveProductsMutationVariables>(
...
export const useUpdateProductMutation = <TError = unknown, TContext = unknown>(
  ...
  >(
    ...
    (variables?: UpdateProductMutationVariables) =>
      requestGraphQL<UpdateProductMutation, UpdateProductMutationVariables>(
