...
import { requestGraphQL } from '~/libs/graphql-fetcher';
...
export const useCreateProductMutation = <
    ...
    useMutation<CreateProductMutation, TError, CreateProductMutationVariables, TContext>(
      ['CreateProduct'],
      (variables?: CreateProductMutationVariables) => requestGraphQL<CreateProductMutation, CreateProductMutationVariables>(CreateProductDocument, variables)(),
      options
    );
...
export const useGetProductQuery = <
    ...
    useQuery<GetProductQuery, TError, TData>(
      ...
      requestGraphQL<GetProductQuery, GetProductQueryVariables>(GetProductDocument, variables),
      options
    );
...
export const useGetProductsQuery = <
    ...
    useQuery<GetProductsQuery, TError, TData>(
      ...
      requestGraphQL<GetProductsQuery, GetProductsQueryVariables>(GetProductsDocument, variables),
      options
    );
...
export const useRemoveProductMutation = <
    ...
    useMutation<RemoveProductMutation, TError, RemoveProductMutationVariables, TContext>(
      ['RemoveProduct'],
      (variables?: RemoveProductMutationVariables) => requestGraphQL<RemoveProductMutation, RemoveProductMutationVariables>(RemoveProductDocument, variables)(),
      options
    );
...
export const useRemoveProductsMutation = <
    ...
    useMutation<RemoveProductsMutation, TError, RemoveProductsMutationVariables, TContext>(
      ['RemoveProducts'],
      (variables?: RemoveProductsMutationVariables) => requestGraphQL<RemoveProductsMutation, RemoveProductsMutationVariables>(RemoveProductsDocument, variables)(),
      options
    );
...
export const useUpdateProductMutation = <
    ...
    useMutation<UpdateProductMutation, TError, UpdateProductMutationVariables, TContext>(
      ['UpdateProduct'],
      (variables?: UpdateProductMutationVariables) => requestGraphQL<UpdateProductMutation, UpdateProductMutationVariables>(UpdateProductDocument, variables)(),
      options
    );